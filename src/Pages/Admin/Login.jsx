        ...
        <>
            ...
            <h1 className="Company-Name">Print<span>Mate</span></h1>
                ...
                <div className="input_container">
                    ...
                    <input placeholder="name@mail.com" title="Inpit title" name="input-name" type="text" className="input_field" id="email_field" onChange={HandleEmail} />
                </div>
                <div className="input_container">
                    ...
                    <input placeholder="Password" title="Inpit title" name="input-name" type="password" className="input_field" id="password_field" onChange={HandlePassWord}/>
                </div>
